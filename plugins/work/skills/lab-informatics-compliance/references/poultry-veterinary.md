# Poultry and veterinary laboratory software

Load this when building or reviewing a LIMS, CoA generator, or reporting feature for a
**poultry or veterinary diagnostic** laboratory — testing bird, flock, environmental, or
animal-health samples rather than human specimens. `domain-regimes.md` says which regimes
exist and `iso-17025-reporting.md` holds the generic clause map; this file says what poultry
and veterinary work specifically forces in a schema, a workflow, or a report template.
