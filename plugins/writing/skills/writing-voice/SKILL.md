...
| `/writing-voice-on` and `/writing-voice-off` | Project toggle. Off by default. On Claude and Grok, a sentinel gates a short prompt card. On Cursor, on copies a project rule and off deletes it. |
